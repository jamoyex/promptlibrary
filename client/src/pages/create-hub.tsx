  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-gray-900">Create an Agent Prompt</h1>
          <p className="text-gray-500 mt-1">Generate a custom conversation AI agent prompt using our tools.</p>
        </div>
      </div>
